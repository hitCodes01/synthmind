...
import useCompatibilityCoach from "../../../hooks/useCompatibilityCoach";

export const CompatibilityCoach = ({ hidden, ...props }) => {
  const input = useRef();
  const { conversation, sendMessage, uploadDocument, isLoading, error } = useCompatibilityCoach();
    ...
    >
      <div className="relative flex flex-col h-full w-full">
        <div className="bg-gradient-to-r from-pink-500 via-purple-600 to-blue-500 p-4 sm:p-6 rounded-lg shadow-lg z-10 text-center mb-4">
          <h1 className="text-3xl sm:text-5xl text-white font-bold">Compatibility Coach</h1>
          <p className="text-lg sm:text-xl text-white mt-2">Check Your Compatibility</p>
        </div>
