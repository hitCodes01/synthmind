...
import "../../chat.css";
import { heroBackground, legaleagle } from "../../assets";
import useLegalEagle from "../../../hooks/useLegalEagle";
...
export const LegalEagle = ({ hidden }) => {
  const input = useRef();
  const {
    conversation,
    sendMessage,
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage: `url(${legaleagle})`,
          opacity: 0.15,
      ...
      <div className="fixed flex flex-col h-full w-full z-10">
        <div className="bg-gradient-to-r from-blue-400 via-blue-600 to-blue-800 p-4 sm:p-6 rounded-lg shadow-lg text-center">
          ...
          <p className="text-lg sm:text-xl text-white mt-2">Your Legal Assistant</p>
        </div>

        {/* Conversation Section */}
        <div className="relative flex flex-col flex-grow p-4 overflow-y-auto bg-gray-900 bg-opacity-60 rounded-lg shadow-lg mb-24 space-y-4">
