...
import { useChat } from "../../../hooks/HealthBot";
...
export const UI = ({ hidden, ...props }) => {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 right-0 bottom-0 z-10 flex justify-between p-4 flex-col pointer-events-auto">
        <div className="self-start bg-gradient-to-r bg-pink-500 hover:bg-pink-600 p-4 rounded-lg shadow-lg animate-fadeIn">
          ...
          <p className="text-white text-lg">Your Personal Health Advisor !!!</p>
        </div>
        ...
        <div className="w-full flex flex-col items-end justify-center gap-4 pointer-events-auto mt-[-5rem]">
          <div className="relative">
            ...
            <div
              className={`${showQuestions ? "block" : "hidden"} sm:block absolute top-0 right-16 sm:static`}
            >
