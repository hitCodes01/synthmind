...
export const BlockChain = ({ hidden }) => {
  const input = useRef();
    ...
    <div className="min-h-screen flex flex-col justify-between relative">
      ...
      <div className="fixed flex flex-col h-full w-full">
        <div className="bg-gradient-to-r from-cyan-500 via-teal-600 to-blue-900 p-4 sm:p-6 rounded-lg shadow-lg z-10 text-center mb-4">
          <h1 className="text-3xl sm:text-5xl text-white font-bold">Blockchain Advisor</h1>
          <p className="text-lg sm:text-xl text-white mt-2">Your BlockChain Advisor!</p>
        </div>
        ...
        <div
          ...
          className="relative z-10 flex flex-col flex-grow p-4 overflow-y-auto bg-gray-900 bg-opacity-40 rounded-lg shadow-lg mb-24 space-y-3"
