...
const quickQuestions = [
  { question: "What are the best strategies to grow my social media following?" },
  { question: "How can I create engaging content that resonates with my audience?" },
  { question: "What are the current trends in social media marketing?" },
  { question: "How can I improve audience engagement on my posts?" },
  { question: "Which social media platforms should I focus on for my business?" },
  { question: "What is the best way to analyze social media performance?" },
  { question: "How can I collaborate with influencers to boost my brand?" },
];
