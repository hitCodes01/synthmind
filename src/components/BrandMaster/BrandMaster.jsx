...
import useBrandMaster from "../../../hooks/useBrandMaster";
...
export const BrandMaster  = ({ hidden }) => {
    ...
    >
      ...
      <div className="fixed flex flex-col h-full w-full z-10">
        <div className="bg-gradient-to-r from-blue-400 via-blue-600 to-blue-800 p-4 sm:p-6 rounded-lg shadow-lg text-center">
          ...
          <p className="text-lg sm:text-xl text-white mt-2">Grow Your Brand!</p>
        </div>
        ...
        {/* Button Area */}
        <div className="fixed bottom-0 left-0 w-full bg-gray-800 shadow-md z-20 p-4 sm:p-4 flex items-center gap-2">
          <button
            onClick={toggleTTS}
