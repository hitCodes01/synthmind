...
const backendUrl = "https://finwiz-three.vercel.app"
...
export const finwizuseChat = () => {
  const context = useContext(ChatContext);
  if (!context) {
    throw new Error("FinWiz useChat must be used within a ChatProvider");
  }
  return context;
};

export default function Chat() {
  const { chat, message, onMessagePlayed, loading, cameraZoomed, setCameraZoomed } = finwizuseChat();
